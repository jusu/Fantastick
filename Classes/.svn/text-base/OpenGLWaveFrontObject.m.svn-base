	...
	if ((self = [super init]))
	{
		...
		for (NSString * line in lines)
		{
			...
			else if ([line hasPrefix:@"m"])
			{
				...
				NSString *mtlPath = [FSCache stringWithModelDirectory: truncLine];
//				[[NSBundle mainBundle] pathForResource:[[truncLine lastPathComponent] stringByDeletingPathExtension] ofType:[truncLine pathExtension]];
